...
// How many bytes are needed to represent the specified
// number of bits
static inline int bytesNeeded(int bitscount)
{
    return (bitscount * .125 == floor(bitscount *.125)) ? (bitscount *.125) : ((int)(bitscount * .125))+1;
}

// How many bytes are needed to encapsulate the width
// using the specified number of plixels
// aligned to the specified number of bytes
